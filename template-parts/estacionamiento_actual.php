        ...
        <div class="flex justify-between w-full px-5 py-3 items-center flex-wrap gap-3">
            ...
            <div id="dropdown2"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton2">
                    <li>
                        <a href="#" data-value="2"
                            class="dropdown-item menu1 block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Estudiantes</a>
                    </li>
                    <li>
                        <a href="#" data-value="3"
                            ...
                            <div data-popover id="chart-info" role="tooltip"
                                ...
                                <div class="p-3 space-y-2">
                                    ...
                                    <p>
                                        ...
                                        echo "Estudiantes: " . esc_html($total_count) . "<br>";
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-3 mb-2">
                        <dl
                            ...
                            <dt class="w-max h-8 px-2 rounded-full bg-orange-100 dark:bg-gray-500 text-orange-600 dark:text-orange-300 text-sm font-medium flex items-center justify-center mb-1"
                                id="dispo">
                            </dt>
                        ...
                        <dl id="time-component"
                            ...
                            <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Hora actual / Hora apertura
                                / Hora cierre
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div id="more-details"
                        ...
                        <dl class="flex items-center justify-between">
                            ...
                            <dd
                                ...
                                // Consulta para obtener la hora con mayor promedio de vehículos
                                $max_hour_query = "
    SELECT DATE_FORMAT(horario_ingreso, '%H:00') AS hour, COUNT(*) AS vehicle_count
    FROM $table_name_ingresos
    GROUP BY hour
    ORDER BY vehicle_count DESC
    LIMIT 1
";

                                $max_hour_result = $wpdb->get_row($max_hour_query);
                                $max_hour = $max_hour_result ? $max_hour_result->hour : 'No data';
                        ...
                        <dl class="flex items-center justify-between">
                            <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal">Máximo igreso vehicular:
                            </dt>
                            <dd
                                ...
                                <?php
                                // Consulta para obtener la fecha con máxima capacidad
                                $max_capacity_query = "
    SELECT DATE(horario_ingreso) AS date, COUNT(*) AS vehicle_count
    FROM $table_name_ingresos
    GROUP BY date
    ORDER BY vehicle_count DESC
    LIMIT 1
";
                                ...
                                $max_capacity_result = $wpdb->get_row($max_capacity_query);
                                $max_capacity_date = $max_capacity_result ? $max_capacity_result->date : 'No data';

                                // Calcula los días desde esa fecha
                                $days_ago = $max_capacity_result ? round((strtotime(date('Y-m-d')) - strtotime($max_capacity_date)) / (60 * 60 * 24)) : 'No data';
                                echo $days_ago;
                                ?> día/s
...
<script>
    ...
    const getChartOptions2 = () => {
        return {
            ...
            labels: ["Personal docente", "Personal no docente", "Estudiantes", "Visitas"],
            dataLabels: {
                enabled: true,
                style: {
                    fontFamily: "Inter, sans-serif",
