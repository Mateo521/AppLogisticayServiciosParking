...
<div class="flex justify-center p-3">
    <div class="max-w-screen-xl w-full">
        <div class="py-5 whitespace-nowrap  w-full">
            <div
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ingreso vehicular
                    </h5>
                    <form class=" mx-auto py-2" action="<?php echo esc_url(admin_url('admin-post.php')); ?>"
                        method="POST">
                        <input type="hidden" name="action" value="insert_ingreso">
                        <input type="hidden" name="redirect_url" value="<?php echo esc_url($current_url); ?>">
                        <div class="flex relative md:flex-nowrap flex-wrap md:gap-2 gap-4">
                            <?php
                            $current_user = wp_get_current_user();
                            $user_id = $current_user->ID;
                            $user_role = $current_user->roles[0];
                            ...
                            // Si el usuario es un autor, bloquea la selección de estacionamiento
                            if ($user_role === 'author') {
                            ...
                            <?php if ($user_role != 'author'): ?>
                                <button id="estacionamiento-button" data-dropdown-toggle="dropdown-estacionamiento"
                                    ...
                                    type="button">
                                    <?php echo get_estacionamiento_name($selected_estacionamiento); ?> <svg
                                ...
                                <!-- Agregar input hidden para estacionamiento -->
                            ...
                            <select id="categoria_index" name="categoria_index"
                                class="bg-gray-50 border border-gray-300 text-gray-900 min-w-max text-sm rounded-lg md:rounded-e-lg  border-s-gray-100 dark:border-s-gray-700 border-s-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <button type="submit"
                                class="px-2 py-2 bg-blue-600 text-white rounded-lg mx-2">Ingresar</button>
                        </div>
                    </form>
            ...
            <div
                ...
                <img class="object-cover w-full rounded-t-lg h-full md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                    ...
                    alt="" style="height:200px;">
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Egreso vehicular
                    </h5>

                    <form id="form2" class="flex items-center  mx-auto py-2 md:flex-nowrap flex-wrap md:gap-2 gap-4" method="post"
                        ...
                        <?php if ($user_role != 'author'): ?>
                            ...
                            <input type="hidden" id="estacionamiento-index2" name="estacionamiento_index2"
                                value="<?php echo $selected_estacionamiento; ?>">
                        <?php else: ?>
                            <div
                                class="text-white bg-gray-700 font-medium md:rounded-l-lg rounded-lg text-sm h-max px-5 py-2.5 text-center inline-flex items-center">
                                Estacionamiento: <?php echo get_estacionamiento_name($selected_estacionamiento); ?>
                                <input type="hidden" id="estacionamiento-index2" name="estacionamiento_index2"
                                    value="<?php echo $selected_estacionamiento; ?>">
                            </div>
                        ...
                        <select id="categoria_index2" name="categoria_index2"
                            class="bg-gray-50 border border-gray-300 text-gray-900  min-w-max text-sm rounded-lg border-s-gray-100 dark:border-s-gray-700 border-s-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="1" selected>Personal no docente</option>
                            <option value="0">Personal docente</option>
                            <option value="3">Visitas</option>
                            <option value="2">Alumnos</option>
