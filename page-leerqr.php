...
if (isset($_SESSION['message'])):
    ...
    <div id="alert-border-3" class="flex items-center px-4 py-2 mb-4 border-t-4 <?php echo $alert_classes; ?>" role="alert">
        ...
        <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-green-50 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 <?php echo $icon_color; ?> <?php echo $button_hover_bg; ?> inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:hover:bg-gray-700"  data-dismiss-target="#alert-border-3" aria-label="Close">
